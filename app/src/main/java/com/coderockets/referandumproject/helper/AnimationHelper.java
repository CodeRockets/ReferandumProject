...
public class AnimationHelper {
    ...
    /*
    private void zoomImageFromThumb(View container , final View thumbView, int imageResId,final Animator mCurrentAnimator) {
        ...
        final ImageView expandedImageView = (ImageView) container.findViewById(
                R.id.expanded_image);
